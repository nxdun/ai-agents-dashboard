  ...
  theme: {
    extend: {
      colors: {
        ...
        'gray-850': '#1A2234', // Custom shade between gray-800 and gray-900
        'primary': {
          50: '#eef2ff',
          100: '#e0e7ff',
          200: '#c7d2fe',
      ...
      boxShadow: {
        ...
        'soft-xl': '0 10px 25px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.04)',
        'soft-2xl': '0 25px 50px -12px rgba(0, 0, 0, 0.05)',
        'highlight': '0 0 15px rgba(99, 102, 241, 0.4)',
      },
      transitionProperty: {
        'height': 'height',
